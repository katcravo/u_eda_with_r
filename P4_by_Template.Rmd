...
This exploratory data analysis covers 2016 presidential campaign contributions from residents of Michigan. The data is publicly available on the federal election commission website.^1^
...
demnrep = subset(contributions.combined, pol_party == "Republican"| pol_party == "Democrat")
#summary(hillndon)
...
ggplot(aes(x = date, y = sum_cont), data = hillndon.conts_by_date_cand)+
  ...
  scale_y_sqrt()+
#(breaks = c(100,1000,10000,100000), labels = c(100,1000,10000,100000))+
